...
/*
 * Load Layerz Guru init
 */
require_once get_template_directory() . '/layerz-init.php';
...
if( ! function_exists( 'layers_setup' ) ) {
	function layers_setup(){
		...
		register_nav_menus( array(
			...
			LAYERS_THEME_SLUG . '-secondary-right' => __( 'Menu Mobile Slider' , 'layerswp' ),
			LAYERS_THEME_SLUG . '-primary' => __( 'Header Menu' , 'layerswp' ),
			LAYERS_THEME_SLUG . '-primary-right' => __( 'Right Menu' , 'layerswp' ),
